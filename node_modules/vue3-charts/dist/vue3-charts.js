...
var useMouse = () => {
    const mouse = vue.inject('chartMouse', {
        index: -1,
        position: { x: 0, y: 0 },
        hover: false
    });
...
var useTooltip = () => {
    ...
    const chart = useChart();
    const show = vue.computed(() => mouse.hover);
...
var script$d = vue.defineComponent({
    ...
    setup(props) {
        const el = vue.ref();
        const chart = useChart();
        const axis = vue.computed(() => {
            return props.position === 'bottom' ? axisBottom : axisLeft;
        });
        const canvas = vue.ref(chart.canvas);
...
function render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.position === 'bottom')
    ? (vue.openBlock(), vue.createElementBlock("g", {
        key: 0,
        class: vue.normalizeClass(`layer-axis-x`),
        ref: "el",
        transform: `translate(0, ${_ctx.canvas.height})` 
      }, null, 8 /* PROPS */, _hoisted_1$b))
    : (vue.openBlock(), vue.createElementBlock("g", {
        key: 1,
        class: vue.normalizeClass(`layer-axis-y`),
        ref: "el",
...
var script$c = vue.defineComponent({
    ...
    setup(props) {
        ...
        const axLeftEl = vue.ref();
        const axBottomEl = vue.ref();
        const axisSpace = vue.reactive({ x: 40, y: 20 });
        const chart = new Chart(props.data, props.config);
        const rotateX = vue.computed(() => props.axis && props.axis.primary && props.axis.primary.rotate);
        const hideX = vue.computed(() => {
            return props.axis && props.axis.primary && props.axis.primary.hide;
        });
        const hideY = vue.computed(() => {
            return props.axis && props.axis.secondary && props.axis.secondary.hide;
        });
        const mouse = vue.reactive({
            index: -1,
            position: { x: 0, y: 0 },
            hover: false
        });
        vue.provide('chart', chart);
        vue.provide('chartMouse', mouse);
        // Data change
        ...
        vue.watch(() => [Object.assign({}, axisSpace), props.direction, props.size, props.margin, props.axis], () => {
            if (chart) {
                chart.changeConfig({
...
const _hoisted_3$6 = { class: "layers" };
const _hoisted_4$3 = { class: "axis" };
const _hoisted_5$3 = { class: "widgets" };

function render$c(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_axis = vue.resolveComponent("axis");
  ...
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$a, [
    (vue.openBlock(), vue.createElementBlock("svg", {
      ...
      vue.createElementVNode("g", _hoisted_3$6, [
        vue.renderSlot(_ctx.$slots, "layers")
      ]),
      vue.createElementVNode("g", _hoisted_4$3, [
        (!_ctx.hideX)
          ? (vue.openBlock(), vue.createBlock(_component_axis, {
              key: 0,
              position: "bottom",
              ref: "axBottomEl",
              rotate: _ctx.rotateX,
              isPrimary: _ctx.direction === 'horizontal'
            }, null, 8 /* PROPS */, ["rotate", "isPrimary"]))
...
var script$b = vue.defineComponent({
    ...
    setup(props) {
        ...
        const extraProps = vue.inject('layerProps', {});
        vue.onMounted(() => {
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("g", {
    class: vue.normalizeClass(`layer-${_ctx.type}`)
  }, [
...
var script$a = vue.defineComponent({
    ...
    setup(props) {
        const chart = useChart();
        const { stacked } = vue.inject('layerProps', { stacked: false });
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Layer = vue.resolveComponent("Layer");

  return (vue.openBlock(), vue.createBlock(_component_Layer, {
    type: "area",
    dataKeys: _ctx.dataKeys
  }, {
    default: vue.withCtx(() => [
      vue.createElementVNode("path", vue.mergeProps(_ctx.toKebabCase(_ctx.getStyle()), { d: _ctx.d }), null, 16 /* FULL_PROPS */, _hoisted_1$9)
    ]),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["dataKeys"]))
}
...
var script$9 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const getDotStyle = vue.computed(() => {
            if (is$1(Function, props.dotStyle)) {
                return props.dotStyle;
            }
            return ({ active }) => computeDotStyle(active);
        });
        vue.watch(points, () => updateLine());
        vue.watch(chart.updates, () => updateLine());
        const toKebabCase = (data) => mapKeys(kebabize, data);
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(_component_Layer, {
    ...
    default: vue.withCtx(() => [
      vue.createElementVNode("path", vue.mergeProps({ class: "chart-line" }, _ctx.toKebabCase(_ctx.getStyle()), {
        d: _ctx.d,
        fill: "none"
      }), null, 16 /* FULL_PROPS */, _hoisted_1$8),
      vue.createCommentVNode(" :stroke=\"stroke\"\n      :stroke-width=\"strokeWidth\"\n      stroke-linejoin=\"round\"\n      stroke-linecap=\"round\" "),
      (!_ctx.hideDot)
        ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_2$6, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.points, (c, i) => {
              return (vue.openBlock(), vue.createElementBlock("circle", vue.mergeProps(_ctx.toKebabCase(_ctx.getDotStyle({ active: i === _ctx.mouse.index, index: i })), {
                key: i,
                cx: c.x,
                cy: c.y
...
var script$8 = vue.defineComponent({
    ...
    setup(props, { emit }) {
        const mouse = useMouse();
        const { stacked, maxWidth } = vue.inject('layerProps', {
            stacked: false,
            maxWidth: -1
        });
        const { bars } = useBars(props.dataKeys, {
        ...
        const getStyleSelected = vue.computed(() => {
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(_component_Layer, {
    ...
    default: vue.withCtx(() => [
      (_ctx.bars.length === 0)
        ? (vue.openBlock(), vue.createElementBlock("text", _hoisted_1$7, "No Data"))
        : vue.createCommentVNode("v-if", true),
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.bars, (bar, i) => {
        return (vue.openBlock(), vue.createElementBlock("rect", vue.mergeProps({ class: "chart-bar" }, 
      ...
      (_ctx.selectedBar)
        ? (vue.openBlock(), vue.createElementBlock("rect", vue.mergeProps({
            key: 1,
            class: "chart-bar"
          }, 
...
var script$7 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const chart = useChart();
        const mouse = useMouse();
        const size = vue.ref(Math.min(chart.canvas.width - chart.canvas.x, chart.canvas.height - chart.canvas.y) / 2);
        const getStyle = vue.computed(() => {
        ...
        const transform = vue.ref(`translate(${size.value + chart.canvas.x}, ${size.value + chart.canvas.y})`);
        let pieSort;
        switch (props.sort) {
            case 'desc':
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock(_component_Layer, {
    ...
    default: vue.withCtx(() => [
      (_ctx.arcs.length === 0)
        ? (vue.openBlock(), vue.createElementBlock("text", _hoisted_1$6, "No Data"))
        : vue.createCommentVNode("v-if", true),
      vue.createElementVNode("g", { transform: _ctx.transform }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.arcs, (arc, i) => {
          return (vue.openBlock(), vue.createElementBlock("path", vue.mergeProps({
            key: i,
            id: `arc-${i}`,
            class: "chart-pie"
...
var script$5 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const xLines = vue.ref([]);
        const yLines = vue.ref([]);
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.data.length)
    ? (vue.openBlock(), vue.createElementBlock("g", {
        ...
        (!_ctx.hideX)
          ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_2$3, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.xLines, (y, i) => {
          ...
          : vue.createCommentVNode("v-if", true),
        (!_ctx.hideY)
          ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_4$2, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.yLines, (x, i) => {
                return (vue.openBlock(), vue.createElementBlock("line", {
                  key: i,
                  x1: x,
                  y1: _ctx.canvas.y,
...
var script$4 = vue.defineComponent({
    ...
    setup(props) {
        ...
        const chart = useChart();
        const canvas = vue.ref(chart.canvas);
        const direction = vue.ref(chart.config.direction);
        ...
        const styleContent = vue.computed(() => {
            if (direction.value === 'vertical') {
                return {
                    top: 5 + 'px',
  ...
  return (_ctx.show)
    ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", {
          ...
          style: vue.normalizeStyle(_ctx.styleContent),
          ref: "el"
        }, [
          vue.renderSlot(_ctx.$slots, "default", { payload: _ctx.items }, () => [
            vue.createElementVNode("div", {
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.items, (item, i) => {
                return (vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  vue.createElementVNode("b", null, vue.toDisplayString(item.label), 1 /* TEXT */),
                  vue.createTextVNode(": " + vue.toDisplayString(item.valueFormatted), 1 /* TEXT */)
                ], 4 /* STYLE */))
              }), 128 /* KEYED_FRAGMENT */))
            ], 4 /* STYLE */)
          ])
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.direction === 'horizontal')
    ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_1$2, [
    ...
    : (vue.openBlock(), vue.createElementBlock("g", _hoisted_4$1, [
        ...
        }, vue.toDisplayString(_ctx.label), 9 /* TEXT, PROPS */, _hoisted_5$1),
        vue.createElementVNode("line", {
          x1: _ctx.y,
          y1: _ctx.canvas.y,
          x2: _ctx.y,
  ...
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
    (vue.openBlock(), vue.createElementBlock("svg", {
      ...
      vue.createElementVNode("g", _hoisted_3, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.rectangles, (r, i) => {
          return (vue.openBlock(), vue.createElementBlock("g", {
            class: vue.normalizeClass(["rectangle", { selected: _ctx.selected === i }]),
            key: i,
            ...
            vue.renderSlot(_ctx.$slots, "default", {
              ...
              vue.createElementVNode("rect", vue.mergeProps(_ctx.toKebabCase(_ctx.getStyle(r)), {
                x: 0,
                y: 0,
                width: r.width,
                height: r.height
              ...
              vue.renderSlot(_ctx.$slots, "text", {
                ...
                vue.createElementVNode("text", _hoisted_6, vue.toDisplayString(r.data.name), 1 /* TEXT */)
              ])
            ])
...
var script = vue.defineComponent({
    ...
    setup() {
        const chart = useChart();
        const mouse = useMouse();
        const bar = vue.ref({ x: 0, y: 0, width: 0, height: 0 });
        const direction = vue.ref('horizontal');
        const canvas = vue.ref({ x: 0, y: 0, width: 0, height: 0 });
        vue.watch(chart.updates, () => {
            canvas.value = chart.canvas;
            direction.value = chart.config.direction;
        }, { immediate: true });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.mouse.hover)
    ? (vue.openBlock(), vue.createElementBlock("g", _hoisted_1, [
...
exports.Area = script$a;
exports.Bar = script$8;
exports.Chart = script$c;
exports.Grid = script$5;
exports.Group = script$3;
exports.HoverBar = script;
exports.Layer = script$b;
exports.Line = script$9;
exports.Marker = script$2;
exports.Pie = script$7;
exports.Responsive = script$6;
exports.Tooltip = script$4;
exports.Treemap = script$1;
exports["default"] = index;
exports.useBars = useBars;
